...
MODEL_PATH = "/home/satya/Desktop/BI/saved_model/Orig/lstm_finetuned_rl.h5"
...
# Fragment-controlled generation
def generate_smiles_with_goal(goal_fragment="CH", num_samples=100):
    generated = []
...
# Evaluation metrics
def compute_metrics(smiles_list, goal_fragment="CH"):
    valid_smiles = []
    novel = 0
    match_goal = 0
    mols = []
    ...
    metrics = {
        ...
        "Target Match %": 100 * match_goal / len(valid_smiles) if valid_smiles else 0,
...
generated_smiles = generate_smiles_with_goal(goal_fragment="CN", num_samples=100)
